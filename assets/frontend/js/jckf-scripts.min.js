...
!function(n,a){function e(){n("body").magnificPopup({delegate:".jckf-donate-btn--primary, .jckf-reward__link--donate",type:"inline"})}function t(){n("body").on({mouseenter:function(){n(this).addClass("jckf-reward__link--hover")},mouseleave:function(){n(this).removeClass("jckf-reward__link--hover")}},".jckf-reward__link")}function r(){var a=n(".jckf-reward__link"),e=n(".jckf-donation-field"),t=n(".jckf-reward-feild");a.on("click",function(){var a=parseInt(n(this).attr("data-amount")),r=""!=e.val()?parseInt(e.val()):0,i=n(this).attr("data-reward-id");a>=r&&e.val(a),t.val(i)})}n(a).ready(function(){e(),t(),r()})}(jQuery,document);