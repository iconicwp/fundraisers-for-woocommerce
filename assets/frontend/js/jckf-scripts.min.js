...
!function(n,e){function a(){n("body").magnificPopup({delegate:".jckf-donate-btn, .jckf-reward__link--donate",type:"inline"})}function t(){n("body").on({mouseenter:function(){n(this).addClass("jckf-reward__link--hover")},mouseleave:function(){n(this).removeClass("jckf-reward__link--hover")}},".jckf-reward__link")}function o(){var e=n(".jckf-reward__link"),a=n(".jckf-donation-field");e.on("click",function(){var e=parseInt(n(this).attr("data-amount")),t=""!=a.val()?parseInt(a.val()):0;e>=t&&a.val(e)})}n(e).ready(function(){a(),t(),o()})}(jQuery,document);